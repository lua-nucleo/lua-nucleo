--------------------------------------------------------------------------------
-- single-BROKEN-IF-non-broken-unstrict-mode-suite.lua: suite used for full
-- suite tests
...
local test = make_suite(
  "single-BROKEN-IF-non-broken-unstrict-mode-suite",
  {
...
test:BROKEN_IF(false) "non_broken_test1" (function()
