...
local fix_filename = function(filename)
  if filename:sub(1, 28) == 'macnica/mint/_lua/lua_sched/' then
    filename = filename:sub(29)
    if PRINT_LINE then
      print("fixing filename to", filename)
    end
  end
  return filename
end
